...
//    personOpt.or
    ...
    System.out.println("Task1 Home Work");
    homework1.printNamesOrdered(persons);
    System.out.println();

    System.out.println("Task2 Home Work");
    homework2.printDepartmentOldestPerson1(persons);
    System.out.println();

    System.out.println("Task3 Home Work");
    homework3.findFirstPersons(persons);
    System.out.println();

    System.out.println("Task4 Home Work");
//    homework4.printDepartmentOldestPerson(persons);
    System.out.println();
